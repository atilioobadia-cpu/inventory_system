                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="3" placeholder="What was this expense for?"
                                  class="w-full px-4 py-2.5 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-electric/50 focus:border-electric">{{ old('description', $expense->description) }}</textarea>
                    ...
                    <div>
                        ...
                        @if($expense->receipt)
                            <div class="mb-2 flex items-center gap-2 text-sm text-gray-600">
                                ...
                                <a href="{{ asset('storage/' . $expense->receipt) }}" target="_blank" class="text-electric hover:underline">Current receipt</a>
                            </div>
                        @endif
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <div x-show="isRecurring" x-cloak x-transition class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <select name="frequency" id="frequency" class="w-full px-4 py-2.5 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-electric/50 focus:border-electric bg-white">
