...
<div x-data="{
        ...
        <form method="GET" action="{{ route('expenses.index') }}">
            <div class="p-4 border-b border-gray-200 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <div>
                    <div class="relative">
                        ...
                        <input type="text" name="search" x-model="search" placeholder="Search expenses..." class="w-full pl-10 pr-4 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary">
                    </div>
                </div>
                <div>
                ...
                <div>
                    <select name="payment_method" x-model="paymentMethod" class="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary bg-white">
                ...
                <div>
                    <select name="status" x-model="status" class="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary bg-white">
            ...
            <div class="p-4 border-b border-gray-200 flex flex-wrap items-center gap-4">
                <div class="flex items-center gap-2">
                    <input type="date" name="from" x-model="dateFrom" class="px-3 py-1.5 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary">
                    <span class="text-gray-500 text-sm">to</span>
                    <input type="date" name="to" x-model="dateTo" class="px-3 py-1.5 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary">
                </div>
        ...
        <div class="overflow-x-auto">
            <table class="data-table">
                ...
                <tbody class="divide-y divide-gray-100">
                    @php
                        $methodIcons = [
                            'cash' => ['bg-green-50 text-green-600', 'Cash', 'M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z'],
                            ...
                            'card' => ['bg-amber-50 text-amber-600', 'Card', 'M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h3m-3.75 3h15a2.25 2.25 0 002.25-2.25V6.75A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25v10.5A2.25 2.25 0 004.5 19.5z'],
                            'other' => ['bg-gray-50 text-gray-700', 'Other', 'M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z'],
                        ];
                        $totalAmount = 0;
                    @endphp
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center justify-center gap-1" x-data="{ open: false }">
                                    <a href="{{ route('expenses.edit', $exp) }}" class="p-1.5 rounded-lg text-gray-500 hover:text-primary hover:bg-gray-100 transition-colors" title="Edit">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10"/></svg>
                                    </a>
                                    <button @click="deleteId = {{ $exp->id }}; showDeleteModal = true" class="p-1.5 rounded-lg text-gray-500 hover:text-red-600 hover:bg-red-50 transition-colors" title="Delete">
                    ...
                    @empty
                        <tr>
                            <td colspan="9" class="px-4 py-16 text-center">
                                ...
                                <p class="text-gray-500 font-medium text-center">No expenses found</p>
                                <p class="text-sm text-gray-500 mt-1">Start by adding your first expense.</p>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
    ...
    <div x-show="showDeleteModal" x-cloak
        ...
        <div @click.away="showDeleteModal = false"
            ...
            <p class="text-sm text-gray-700 mb-4">Are you sure you want to delete this expense? This will permanently remove it.</p>
