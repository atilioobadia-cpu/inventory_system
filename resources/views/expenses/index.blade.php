                        ...
                        <tr class="hover:bg-card-bg transition-colors">
                            ...
                            <td class="px-4 py-3 text-center">
                                @if($exp->status === 'approved')
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-success-light text-success">Approved</span>
                                @elseif($exp->status === 'rejected')
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-danger-light text-danger">Rejected</span>
                                @else
