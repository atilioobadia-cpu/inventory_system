...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <!-- Sales Report -->
        <a href="{{ route('reports.sales') }}" class="group bg-white rounded-lg border border-border p-6 hover:transition-all duration-200">
        ...
        <!-- Purchase Report -->
        <a href="{{ route('reports.purchases') }}" class="group bg-white rounded-lg border border-border p-6 hover:transition-all duration-200">
            <div class="flex items-center gap-4">
        ...
        <!-- Inventory Report -->
        <a href="{{ route('reports.inventory') }}" class="group bg-white rounded-lg border border-border p-6 hover:transition-all duration-200">
            <div class="flex items-center gap-4">
        ...
        <!-- Expense Report -->
        <a href="{{ route('reports.expenses') }}" class="group bg-white rounded-lg border border-border p-6 hover:transition-all duration-200">
            <div class="flex items-center gap-4">
        ...
        <!-- Profit & Loss -->
        <a href="{{ route('reports.profit-loss') }}" class="group bg-white rounded-lg border border-border p-6 hover:transition-all duration-200">
            <div class="flex items-center gap-4">
        ...
        <!-- Tax Report -->
        <a href="{{ route('reports.tax') }}" class="group bg-white rounded-lg border border-border p-6 hover:transition-all duration-200">
            <div class="flex items-center gap-4">
        ...
        <!-- Customer Report -->
        <a href="{{ route('reports.customers') }}" class="group bg-white rounded-lg border border-border p-6 hover:transition-all duration-200">
            <div class="flex items-center gap-4">
        ...
        <!-- Supplier Report -->
        <a href="{{ route('reports.suppliers') }}" class="group bg-white rounded-lg border border-border p-6 hover:transition-all duration-200">
            <div class="flex items-center gap-4">
