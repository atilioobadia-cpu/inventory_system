...
<div x-data="{ deleteModal: false, deleteUrl: '', deleteName: '' }">
        ...
        <form method="GET" action="{{ route('customers.index') }}">
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div class="flex gap-2">
                    <select name="customer_type" class="flex-1 border border-border rounded-lg text-sm px-3 py-2 focus:outline-none focus:ring-2 focus:ring-accent/20 focus:border-accent text-gray-600">
    ...
    <div class="bg-white rounded-xl border border-border overflow-hidden">
                    ...
                    <tr class="hover:bg-card-bg transition-colors">
                        ...
                        <td class="px-4 py-3 text-center">
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                ...
                                @elseif($customer->customer_type === 'business') bg-blue-50 text-blue-700
                        ...
                        <td class="px-4 py-3 text-center">
                            <div class="flex items-center justify-center gap-1">
                                <a href="{{ route('customers.show', $customer) }}" class="p-1.5 text-muted hover:text-accent rounded-lg hover:bg-primary-light transition-colors" title="View">
                                ...
                                @can('edit_customers')
                                <a href="{{ route('customers.edit', $customer) }}" class="p-1.5 text-muted hover:text-accent rounded-lg hover:bg-primary-light transition-colors" title="Edit">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
        ...
        <div class="py-16 text-center">
            ...
            @can('create_customers')
            <a href="{{ route('customers.create') }}" class="inline-flex items-center gap-2 bg-primary text-white px-4 py-2 rounded-lg text-sm font-semibold hover:bg-primary-dark transition-colors">
                Add Customer
            </a>
            @endcan
        </div>
    ...
    <div x-show="deleteModal" x-cloak
        ...
        <div class="flex items-center justify-center min-h-screen px-4">
            ...
            <div class="relative bg-white rounded-xl max-w-md w-full p-6">
                ...
                <p class="text-sm text-gray-600 mb-6">Are you sure you want to delete <span class="font-semibold" x-text="deleteName"></span>? This will affect sales records.</p>
