...
<div x-data="{ deleteModal: false, deleteUrl: '', deleteName: '' }">
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">{{ $customers->total() ?? 0 }} customers</p>
        </div>
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-4 py-3 text-right font-medium {{ ($customer->current_balance ?? 0) > 0 ? 'text-danger' : 'text-gray-800' }}">
    ...
    <div x-show="deleteModal" x-cloak
        ...
        <div class="flex items-center justify-center min-h-screen px-4">
            ...
            <div class="relative bg-white rounded-xl shadow-xl max-w-md w-full p-6">
                <h3 class="text-lg font-semibold text-gray-800 mb-2">Delete Customer</h3>
