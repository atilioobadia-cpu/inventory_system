    ...
    <div class="bg-card-bg rounded-lg border p-4">
        <form method="GET" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
            ...
            <div class="flex gap-2">
                <input type="date" name="from_date" value="{{ request('from_date') }}" class="flex-1 px-3 py-2 border border-border rounded-lg text-sm focus:ring-2 focus:ring-accent">
                <input type="date" name="to_date" value="{{ request('to_date') }}" class="flex-1 px-3 py-2 border border-border rounded-lg text-sm focus:ring-2 focus:ring-accent">
            </div>
