...
<div class="space-y-6" x-data="purchaseForm()">
    ...
    <div class="flex items-center justify-between">
        ...
        <a href="{{ route('purchases.show', $purchase) }}" class="px-4 py-2 bg-control-bg hover:bg-gray-200 text-body rounded-lg text-sm font-medium">Cancel</a>
    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="space-y-6">
                <div class="bg-white rounded-xl border p-6 sticky top-20">
                    ...
                    @if($purchase->status === 'draft')
                    <div class="mt-6 space-y-3">
                        <button type="submit" name="action" value="draft" class="w-full py-2.5 bg-primary hover:bg-primary-dark text-white rounded-lg font-medium text-sm transition-colors">Update Purchase</button>
                        <button type="submit" name="action" value="receive" class="w-full py-2.5 bg-primary hover:bg-primary-dark text-white rounded-lg font-medium text-sm transition-colors">Update & Receive</button>
                    </div>
                    @endif
                </div>
            </div>
