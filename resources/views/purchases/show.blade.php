...
<div class="space-y-4">
    ...
    <div class="flex items-center justify-between">
        <div>
            <nav class="flex items-center text-sm text-gray-500 mb-1">
                ...
                <svg class="h-4 w-4 mx-1 text-gray-500" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5"/></svg>
                <span class="text-gray-900 font-medium">{{ $purchase->invoice_number }}</span>
            </nav>
            <div class="flex items-center gap-3">
                ...
                @else
                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-white text-gray-900">Draft</span>
                @endif
            </div>
        </div>
            ...
            <table class="w-full text-sm">
                <thead class="bg-white border-b">
                    <tr>
                        ...
                        <th class="px-4 py-3 text-center font-semibold text-gray-700">Received Qty</th>
                        <th class="px-4 py-3 text-right font-semibold text-gray-700">Unit Cost</th>
                        <th class="px-4 py-3 text-right font-semibold text-gray-700">Discount</th>
                        <th class="px-4 py-3 text-right font-semibold text-gray-700">Tax</th>
                ...
                <tfoot class="bg-white border-t">
                    <tr>
                        <td colspan="6"></td>
                        <td class="px-4 py-2 text-right text-sm font-medium text-gray-700">Subtotal</td>
                        <td class="px-4 py-2 text-right text-sm font-medium text-gray-900">TZS {{ number_format($purchase->subtotal ?? 0) }}</td>
                    </tr>
                    <tr>
                        <td colspan="6"></td>
                        <td class="px-4 py-2 text-right text-sm text-gray-700">Tax (18%)</td>
                        <td class="px-4 py-2 text-right text-sm text-gray-900">TZS {{ number_format($purchase->tax_amount ?? 0) }}</td>
                    </tr>
                    <tr>
                        <td colspan="6"></td>
                        <td class="px-4 py-2 text-right text-sm text-gray-700">Discount</td>
    ...
    <div class="card card-body max-w-md">
