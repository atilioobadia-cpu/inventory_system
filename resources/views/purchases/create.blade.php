...
<div class="space-y-6" x-data="purchaseForm()">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <h1 class="text-2xl font-bold text-gray-900">Create Purchase</h1>
        </div>
        <a href="{{ route('purchases.index') }}" class="px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg text-sm font-medium">Cancel</a>
    </div>
            ...
            <div class="space-y-6">
                <div class="bg-white rounded-xl border p-6 sticky top-20">
                    ...
                    <div class="mt-6 space-y-3">
                        ...
                        <button type="submit" name="action" value="receive" class="w-full py-2.5 bg-tz-green hover:bg-tz-green-dark text-white rounded-lg font-medium text-sm transition-colors">Save & Receive</button>
                    </div>
                </div>
            </div>
        </div>
