...
@section('breadcrumbs')
    ...
    <span class="text-body font-medium">Expense Categories</span>
@endsection
            ...
            <table class="w-full">
                <thead>
                    <tr class="bg-card-bg border-b border-border">
                        ...
                        <th class="text-center px-6 py-3 text-xs font-semibold text-muted uppercase tracking-wider">Status</th>
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="px-6 py-16 text-center">
                                ...
                                <p class="text-muted font-medium">No expense categories found</p>
                                <p class="text-sm text-muted mt-1">Create your first category to organize expenses.</p>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
    ...
    <div x-show="showDeleteModal" x-cloak
        ...
        <div @click.away="showDeleteModal = false"
            ...
            <div class="flex items-center gap-3 mb-4">
                ...
                <div>
                    <h3 class="text-lg font-semibold text-heading">Delete Category</h3>
