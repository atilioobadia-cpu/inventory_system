...
<span class="mx-2">/</span>
<span class="text-gray-900">Create New Item</span>
@endsection
    ...
    <form method="POST" action="{{ route('items.store') }}" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-4">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div class="sm:col-span-2">
                            <label for="name" class="form-label flex items-center gap-1.5">
                                <svg class="w-4 h-4 text-gray-500" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M21 7.5l-9-5.25L3 7.5m18 0l-9 5.25m9-5.25v9l-9 5.25M3 7.5l9 5.25M3 7.5v9l9 5.25m0-9v9"/></svg>
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 mt-1">Leave empty to auto-generate after save</p>
                ...
                {{-- Stock Levels --}}
                <div class="card card-body">
                    <h2 class="text-lg font-semibold text-gray-900 mb-4">Stock Levels</h2>
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        <div>
            ...
            <div class="space-y-4">
                {{-- Image Upload --}}
                <div class="card card-body">
                    <h2 class="text-lg font-semibold text-gray-900 mb-4">Item Image</h2>
                    <div class="border-2 border-dashed border-border rounded-lg p-6 text-center hover:border-primary/50 transition-colors">
                        <div x-show="!imagePreview">
                            <svg class="w-12 h-12 text-gray-500 mx-auto mb-3" fill="none" stroke="currentColor" stroke-width="1" viewBox="0 0 24 24">
                ...
                {{-- Unit & Status --}}
                <div class="card card-body">
                    <h2 class="text-lg font-semibold text-gray-900 mb-4">Other Details</h2>
                    <div class="space-y-4">
                        <div>
