...
<span class="mx-2">/</span>
<span class="text-gray-900">All Categories</span>
@endsection
...
<div x-data="{ deleteModal: false, deleteUrl: '', deleteName: '' }">
    ...
    <div class="card overflow-hidden">
            ...
            <table class="data-table">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-4 py-3 text-gray-700">{{ $category->parent->name ?? '-' }}</td>
                        ...
                        <td class="px-4 py-3 text-center text-gray-700">{{ $category->sort_order ?? 0 }}</td>
                        <td class="px-4 py-3 text-center">
                            <div class="flex items-center justify-center gap-1">
                                @can('edit_categories')
                                <a href="{{ route('categories.edit', $category) }}" class="p-1.5 text-gray-500 hover:text-primary rounded-lg hover:bg-gray-100 transition-colors" title="Edit">
        ...
        <div class="py-16 text-center">
            ...
            <p class="text-sm text-gray-500 mb-4">Create your first category to organize items.</p>
            @can('create_categories')
            <a href="{{ route('categories.create') }}" class="btn btn-primary">
                Add Category
            </a>
    ...
    <div x-show="deleteModal" x-cloak
        ...
        <div class="flex items-center justify-center min-h-screen px-4">
            ...
            <div class="relative bg-white rounded-lg max-w-md w-full p-5">
                ...
                <p class="text-sm text-gray-700 mb-6">Are you sure you want to delete <span class="font-semibold" x-text="deleteName"></span>?</p>
