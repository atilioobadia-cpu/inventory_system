...
<div x-data="{ deleteModal: false, deleteUrl: '', deleteName: '' }">
    ...
    <div class="bg-white rounded-xl border border-border overflow-hidden">
                    ...
                    <tr class="hover:bg-card-bg transition-colors">
                        <td class="px-4 py-3">
                            <div class="flex items-center gap-2">
                                @if($category->parent)
                                <span class="text-gray-300">â””â”€</span>
                                @endif
                        ...
                        <td class="px-4 py-3 text-center">
                            <div class="flex items-center justify-center gap-1">
                                @can('edit_categories')
                                <a href="{{ route('categories.edit', $category) }}" class="p-1.5 text-muted hover:text-accent rounded-lg hover:bg-primary-light transition-colors" title="Edit">
        ...
        <div class="py-16 text-center">
            ...
            @can('create_categories')
            <a href="{{ route('categories.create') }}" class="inline-flex items-center gap-2 bg-primary text-white px-4 py-2 rounded-lg text-sm font-semibold hover:bg-primary-dark transition-colors">
                Add Category
            </a>
            @endcan
        </div>
