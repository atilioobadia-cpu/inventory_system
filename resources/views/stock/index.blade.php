...
<div x-data="{
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 gap-4">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Monitor current inventory levels across all items</p>
        </div>
        <a href="{{ route('stock.movements') }}" class="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
        <form method="GET" action="{{ route('stock.index') }}">
            ...
            <div class="p-4 border-b border-gray-100 flex items-center gap-3">
                ...
                <div class="ml-auto">
                    <a href="{{ route('stock.export', request()->query()) }}" class="inline-flex items-center gap-2 px-4 py-1.5 text-sm font-medium text-gray-700 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                    ...
                    @empty
                        <tr>
                            <td colspan="11" class="px-4 py-16 text-center">
                                ...
                                <p class="text-sm text-gray-400 mt-1">Add items to see stock levels here.</p>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
