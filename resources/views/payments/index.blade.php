                ...
                <tbody class="divide-y divide-border">
                    @forelse($payments ?? [] as $payment)
                        <tr class="hover:bg-card-bg">
                            ...
                            <td class="px-6 py-4 text-body font-mono text-xs">{{ $payment->payable->invoice_number ?? $payment->payable->po_number ?? '-' }}</td>
                            ...
                            <td class="px-6 py-4 text-body">{{ $payment->createdBy->name ?? '-' }}</td>
                        </tr>
                    @empty
                        <tr>
