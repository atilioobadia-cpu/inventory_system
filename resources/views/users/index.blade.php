            ...
            <table class="w-full text-sm">
                <thead class="bg-card-bg">
                    <tr>
                        ...
                        <th class="text-left px-6 py-3 font-medium text-muted">Role</th>
                        ...
                        <th class="text-left px-6 py-3 font-medium text-muted">Last Login</th>
                ...
                <tbody class="divide-y divide-border">
                    @forelse($users ?? [] as $user)
                        <tr class="hover:bg-card-bg">
                            ...
                            <td class="px-6 py-4 text-muted text-xs">{{ $user->last_login_at ? $user->last_login_at->diffForHumans() : 'Never' }}</td>
                            <td class="px-6 py-4 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    <a href="{{ route('users.edit', $user) }}" class="p-1.5 text-muted hover:text-warning hover:bg-warning-light rounded-lg transition-colors" title="Edit">
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="px-6 py-12 text-center text-muted">
                                <svg class="w-12 h-12 mx-auto text-muted/50 mb-3" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z"/></svg>
