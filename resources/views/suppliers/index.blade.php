...
<span class="mx-2">/</span>
<span class="text-gray-900">All Suppliers</span>
@endsection
...
<div x-data="{ deleteModal: false, deleteUrl: '', deleteName: '' }">
    <div class="page-header mb-6">
        <div class="page-title">
            ...
            <p class="page-subtitle">{{ $suppliers->total() ?? 0 }} suppliers</p>
        </div>
            ...
            <table class="data-table">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        <td class="px-4 py-3">
                            <a href="{{ route('suppliers.show', $supplier) }}" class="font-medium text-gray-900 hover:text-primary">{{ $supplier->name }}</a>
                        </td>
                        ...
                        <td class="px-4 py-3 text-right font-medium {{ ($supplier->current_balance ?? 0) > 0 ? 'text-red-600' : 'text-gray-900' }}">
                        ...
                        <td class="px-4 py-3 text-center">
                            <div class="flex items-center justify-center gap-1">
                                <a href="{{ route('suppliers.show', $supplier) }}" class="p-1.5 text-gray-500 hover:text-primary rounded-lg hover:bg-gray-100 transition-colors" title="View">
                                ...
                                @can('edit_suppliers')
                                <a href="{{ route('suppliers.edit', $supplier) }}" class="p-1.5 text-gray-500 hover:text-primary rounded-lg hover:bg-gray-100 transition-colors" title="Edit">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
    ...
    <div x-show="deleteModal" x-cloak
        ...
        <div class="flex items-center justify-center min-h-screen px-4">
            ...
            <div class="relative bg-white rounded-lg max-w-md w-full p-5">
                ...
                <p class="text-sm text-gray-700 mb-6">Are you sure you want to delete <span class="font-semibold" x-text="deleteName"></span>? This may affect purchase records.</p>
