...
<span class="mx-2">/</span>
<a href="{{ route('suppliers.show', $supplier) }}" class="hover:text-tz-green transition-colors">{{ $supplier->name }}</a>
<span class="mx-2">/</span>
...
<div class="max-w-3xl">
    ...
    <form method="POST" action="{{ route('suppliers.update', $supplier) }}">
        ...
        <div class="flex justify-end gap-3 mt-6">
            ...
            <button type="submit" class="px-6 py-2.5 text-sm font-semibold text-white bg-tz-green rounded-lg hover:bg-tz-green-dark transition-colors">Update Supplier</button>
        </div>
    </form>
</div>
@endsection