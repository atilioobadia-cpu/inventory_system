...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div class="bg-white rounded-xl border border-border p-5 flex items-center gap-4 card-hover">
            ...
            <div>
                ...
                <p class="text-2xl font-bold text-heading">{{ number_format($totalItems ?? 0) }}</p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl border border-border p-5 flex items-center gap-4 card-hover">
            ...
            <div>
                <p class="text-sm text-muted">Stock Value</p>
                <p class="text-2xl font-bold text-heading">TZS {{ number_format($stockValue ?? 0) }}</p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl border border-border p-5 flex items-center gap-4 card-hover">
            ...
            <div>
                <p class="text-sm text-muted">Today's Sales</p>
                <p class="text-2xl font-bold text-heading">TZS {{ number_format($todaySalesAmount ?? 0) }}</p>
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 bg-white rounded-xl border border-border p-6">
            <h3 class="text-lg font-semibold text-heading mb-4">Monthly Sales</h3>
        ...
        <div class="bg-white rounded-xl border border-border p-6">
            <h3 class="text-lg font-semibold text-heading mb-4">Recent Activity</h3>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {{-- Top Selling Items --}}
        <div class="bg-white rounded-xl border border-border p-6">
            <h3 class="text-lg font-semibold text-heading mb-4">Top Selling Items</h3>
        ...
        <div class="bg-white rounded-xl border border-border p-6">
            <div class="flex items-center justify-between mb-4">
                <h3 class="text-lg font-semibold text-heading">Low Stock Alerts</h3>
