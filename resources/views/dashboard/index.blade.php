    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
        ...
        <div class="stat-card">
            ...
            <div>
                ...
                <p class="stat-value">TZS {{ number_format($stockValue ?? 0) }}</p>
            </div>
        </div>
        ...
        <div class="stat-card">
            ...
            <div>
                ...
                <p class="stat-value">TZS {{ number_format($todaySalesAmount ?? 0) }}</p>
            </div>
        </div>
        ...
        <div class="stat-card">
            ...
            <div>
                ...
                <p class="stat-value text-amber-600">{{ $lowStockCount ?? 0 }}</p>
            </div>
        </div>
    </div>
                ...
                <table class="data-table">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr>
                            ...
                            <td class="py-2 text-right text-gray-700">{{ $item->total_sold }}</td>
                            <td class="py-2 text-right font-medium text-gray-900">TZS {{ number_format($item->total_revenue) }}</td>
                        </tr>
                        @empty
                        <tr>
                            <td colspan="3" class="py-8 text-center text-gray-500">No sales data yet</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
                ...
                <table class="data-table">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr>
                            ...
                            <td class="py-2 text-right text-gray-700">{{ $item->current_stock }}</td>
                            <td class="py-2 text-right text-gray-700">{{ $item->reorder_point }}</td>
                            <td class="py-2">
                        ...
                        @empty
                        <tr>
                            <td colspan="4" class="py-8 text-center text-gray-500">All items are well stocked</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
